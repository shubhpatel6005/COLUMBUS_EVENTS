...
export function UpcomingEvents() {
  ...
  return (
    <section
      id="events"
      className="scroll-mt-16 border-t border-border bg-background px-4 py-16"
    >
      <div className="mx-auto max-w-3xl">
        <p className="text-center font-heading text-sm font-semibold tracking-widest text-rapids-teal uppercase">
          Upcoming
        </p>
        ...
        <ul className="mt-8 space-y-4">
          {events.map((event) => (
            <li key={event.slug}>
              ...
              >
                <p className="text-sm text-rapids-teal">
